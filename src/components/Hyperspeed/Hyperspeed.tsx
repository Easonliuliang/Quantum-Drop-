...
const Hyperspeed = ({
  ...
  useEffect(() => {
    ...
    class CarLights {
      ...
      constructor(webgl: App, options: AppOptions, colors: number[], speed: [number, number], fade: THREE.Vector2) {
        this.webgl = webgl;
        this.options = options;
        this.colors = colors;
        this.speed = speed;
      ...
      init() {
        ...
        let colors: THREE.Color[] | THREE.Color = this.colors.map(c => new THREE.Color(c));
    ...
    class LightsSticks {
      ...
      init() {
        ...
        const colors = new THREE.Color(options.colors.sticks);
        ...
        for (let i = 0; i < totalSticks; i++) {
          ...
          aColor.push(colors.r);
          aColor.push(colors.g);
          aColor.push(colors.b);
    ...
    if (container) {
      ...
      const options: AppOptions = {
        ...
        colors: mergedOptions.colors as Required<NonNullable<EffectOptions['colors']>>
      };
